...
Route::group(['prefix' => config('admin.prefix', 'admin'), 'namespace' => 'Pingpong\Admin\Controllers'], function () {
    ...
    Route::get('admin/singleadmin/{id}' , [ 'as' => 'signleadmin' , 'uses' => 'AdminsubadminController@singleAdmin' ]);
    ...
    Route::get('/adduser', ['as' => 'addUser', 'uses' => 'AdminsubadminController@addUser']);
   ...
   // Route::post('riderpromos', ['as' => 'riderpromos', 'uses' => 'AdminsubadminController@riderpromos']);
    ...
    Route::any('driver/issuedetail/{id}', ['as' => 'ridedetail', 'uses' => 'DriverController@ridedetail']);
