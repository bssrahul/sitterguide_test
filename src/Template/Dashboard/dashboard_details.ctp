...
<div class="col-md-9 col-lg-10 col-sm-8 lg-width80">
					...
					<div class="col-xs-12 col-sm-5 col-md-6 col-lg-6">
						<h3>
                           ...
                           <!-- <img src="<?php //echo HTTP_ROOT; ?>img/db-profile-home-icon.png" alt="db-profile-home-icon"> -->
							...
							<?php echo $this->requestAction('app/get-translate/'.base64_encode('Dashboard')); ?>
						</h3>
					</div>					
        ...
        <div class="row">
			...
			<h1 class="dashboard-h">Sitter Statics</h1>
					 ...
					 <div class="outer-db-box">
						<div class=" top-box">
						  ...
						  <div class="topbox-text">
							<h4> <?php if($totalEarningThisMonth > 0) echo (@$totalEarningThisMonth/100); else echo @$totalEarningThisMonth; ?>
							</h4>
						...
						<div class="second-box-header">
						 <div class="col-xs-8 col-sm-6 col-md-6 col-lg-6">
						  ...
						  <div class="col-xs-4 col-sm-6 col-md-6 col-lg-6 no-padding-right setting-arrows ">
						...
						<div class="below-second-box collapse in" id="revenue1">
						  ...
						  <div>
							<h4 style="padding:10px 0px;" class="text-center cal-caption">
		...
		<div class="row">
			<h1 class="dashboard-h">Guest Statics</h1>
				...
				<div class="outer-db-box">
					...
					<div class="outer-db-box">
						<div class=" top-box">
						  ...
						  <div class="topbox-text">
							<h4><?php if($totalPaidThisMonth>0) echo (@$totalPaidThisMonth/100); else echo @$totalPaidThisMonth; ?>
							</h4>
			...
			<div class="outer-db-box">
			 ...
			 <div class="second-box-header">
				 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
					<h5><?php echo $this->requestAction('app/get-translate/'.base64_encode('Booking Request Sent')); ?>
					</h5>
				  </div>
...
#myCarousel-detail .carousel-control.left {background-image: linear-gradient(to right, rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 100%) !important;background-repeat: repeat-x;	}
#myCarousel-detail .carousel-control.right {background-image:none !important;}
.btn-paddin {padding-top:20px !important;}
#myCarousel-detail .carousel-control .glyphicon-chevron-left, .carousel-control .glyphicon-chevron-right, .carousel-control .icon-prev, .carousel-control .icon-next {font-size: 30px;height: 30px;
margin-top: -5px !important;width: 30px;}
</style>
...
<script type="text/javascript">
    ...
    function drawChart(){
     ...
     <?php $colorArr = ['0'=>'#67AAE4','1'=>'#72A105','2'=>'#F57900']; ?>
      
      var data = google.visualization.arrayToDataTable([
         ['Element', 'Earn in $', { role: 'style' }],
         <?php 
           $clr=0;
        if(!empty($threeMonthEarn)){
          foreach($threeMonthEarn as $key=>$single_earn){ ?>
			
			 ['<?php echo $key; ?>', <?php if($single_earn > 0) echo (@$single_earn/100); else echo @$single_earn; ?>, '<?php echo $colorArr[$clr] ?>'],  
     ...
     function drawChartPaid() {
      ...
      var data1 = google.visualization.arrayToDataTable([
         ['Element', 'Paid in $', { role: 'style' }],
         <?php 
           $clr=0;
          if(!empty($threeMonthPaid)){ 
          foreach($threeMonthPaid as $key=>$single_month){ ?>
			
			 ['<?php echo $key; ?>', <?php if($single_month>0) echo (@$single_month/100); else echo @$single_earn; ?>, '<?php echo $colorArr[$clr] ?>'],  
...
<style>
.revenue-graph #chart{overflow:hidden !important}
</style>
