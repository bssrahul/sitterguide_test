			...
			<div class="help-listing1">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
						<?php  if(empty($categoriesData)){?><div class="col-md-3 col-md-offset-5"><h4><?php echo $this->requestAction('app/get-translate/'.base64_encode("Record Not Found"));?><h4></div> <?php	 }
							else{	$count=1;
