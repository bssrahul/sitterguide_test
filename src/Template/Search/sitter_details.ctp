...
<!-- [Banner Area Start] -->
          ...
          $userloginstatus = $session->read("User");
					// $userloginstatus = $session->read("User");
         /* print_r($userloginstatus);
          echo isset($userloginstatus['id']);die;*/
          // echo count($userloginstatus);
          ...
          <div class="banner-info-wrapper">
            <div class="banner-info-inner">
              <div class="client-image center-block">
                <img src="<?php echo HTTP_ROOT.'img/uploads/'.(@$userData->image != ''?@$userData->image:'dm.png'); ?>" class="img-responsive img-circle img-thumbnail" alt="client" > 
              </div>
                                                ...
                                                <= 3.5 && $rating_sum > 3){ echo "checked"; } } ?> />
                                                  ...
                                                  <= 3 && $rating_sum > 2.5){ echo "checked"; } } ?>/>
                                                    ...
                                                    <= 2.5 && $rating_sum > 2){ echo "checked"; } } ?>/>
                                                      ...
                                                      <h5 class="additional">
                                                        <!--<a href="#" data-toggle="modal" data-target="#myModal79"></a>-->
														<?php echo $this->requestAction('app/get-translate/'.base64_encode('More Services Available')); ?> 
                                                        
                                                      </h5>
                                                      <div class="text-center">
													     <?php 
				                                            if(isset($userloginstatus['id'])){ 
																 if($guests_Info == ""){
																 ?>
                                            ...
                                            <div class="container">
                                                  ...
                                                  <div class="row spad-top ">
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                      <div class="row">
                                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                          <div class="spad-top ">   
                                                            <img src="<?php echo HTTP_ROOT.'img/uploads/'.(@$userData->image != ''?@$userData->image:'dm.png'); ?>" title="sitter image" class="img-responsive img-thumbnail" alt="sitter"> 
                                                          </div>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                      ...
                                                      <div class="btn-group btn-width100 pt15">
                                                        ...
                                                        <div class="likebox favourite_sitter1"> 
                                                          ...
                                                          <a data-count="<?php echo $userData->id; ?>" href="javascript:void(0);" class="unlike favouriteSection" data-href="<?php echo HTTP_ROOT.'Search/favorite-sitter/'.base64_encode(convert_uuencode($userData->id)).'/'.base64_encode(convert_uuencode($logedInUserId)); ?>" title="Favorite"> 
                                                            <i class="icon-lock fa fa-heart heart-pos">
                                                            </i>
                                                          </a>
                                                          <?php }else{ ?>
                                                          <a data-count="<?php echo $userData->id; ?>" href="javascript:void(0);" class="like favouriteSection" data-href="<?php echo HTTP_ROOT.'Search/favorite-sitter/'.base64_encode(convert_uuencode($userData->id)).'/'.base64_encode(convert_uuencode($logedInUserId)); ?>" title="Unfavorite" >
                                              ...
                                              <div class="video-container">
                                                <div class="imgWrap">
                                                   ...
                                                   <section id="vid-wrap" style="margin:0px; max-width:100%;">	
                                                          <button type="button" class="close" data-dismiss="modal" style="display:none;">×</button>  
                                                    <div class="videoContainer" style="max-width:100%;">	
                                                        <video class="responsive-video" id="myVideo"  controls="" preload="auto" poster="poster.png">
                                                          <source src="https://a0.muscache.com/airbnb/static/Paris-P1-1.mp4" type="video/mp4"></source>	 
                                                        </video>
...
foreach($userData->user_sitter_galleries as $key=>$single_image){ ?>
                                                          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                            <?php $fg=1; ?>
                                                            <img src="<?php echo HTTP_ROOT.'img/uploads/'.$single_image->image; ?>" class="img-responsive responsivept15 img-thumbnail" alt="client1">
                                                          </div>
                                                          <?php 
											   ...
											   /*$skills = ["languages","experience","training_techniques"]; 
												...
												?>
                                                                       ...
                                                                       <div class="one">
                                                                        ...
                                                                        <h5 class="small-title"><?php echo $this->requestAction('app/get-translate/'.base64_encode('Badges')); ?> &nbsp;
                                              ...
                                              <div class="row pt10 ">
												...
												<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                  <div class="img-thumbnail"> 
                                                    <img  src="<?php echo HTTP_ROOT.'img/uploads/'.$single_pet->image; ?>" class="img-responsive img-thumbnail responsivept15" alt="client1">
                                                ...
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                  <div class="img-thumbnail"> 
                                                    <img src="<?php echo HTTP_ROOT; ?>img/detail-client3.jpg" class="img-responsive responsivept15 img-thumbnail" alt="client1">
                          ...
                          <div class="st-outer"  >
							<div class="st-inner"> 
                                ...
                                <ul class="care-list">
								  ...
								  ?>                       <img src="<?php echo HTTP_ROOT; ?>img/day-care.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Day Care')); ?> : 
															<span><?php  if(!empty($sitterServiceData->sh_day_rate))
																	...
																	?>
															  <i data-toggle="tooltip" title="Day time stay at the sitters home" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
														  <li>
															...
															<?php  if(!empty($sitterServiceData->sh_night_rate))
																	...
																	?>
															  <i data-toggle="tooltip" title="Overnight stay at the sitters home" class="fa fa-exclamation-circle">
															  </i> 
															</span>
														  </li>
														  <!--
														  ...
														  <li>
															...
															<span>
																<?php  if(!empty($sitterServiceData->mp_grooming_rate))
																	...
																	?>
															  <i data-toggle="tooltip" title="Hair cutting or styling" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
														  <li>
															<img src="<?php echo HTTP_ROOT; ?>img/training.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Tutoring')); ?> : 
															<span>
																<?php  if(!empty($sitterServiceData->mp_training_rate))
																	...
																	?>
															  <i  data-toggle="tooltip" title="Tutoring for learing new skills and knowledge" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
														  <li>
															<img src="<?php echo HTTP_ROOT; ?>img/drive-upto.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Drive (up to 10km one way)')); ?> : 
															<span> 
															<?php  if(!empty($sitterServiceData->mp_driving_rate))
																	...
																	?>
															  <i data-toggle="tooltip" title="Sitter driver service to and or from you" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
														  <li>
															<img src="<?php echo HTTP_ROOT; ?>img/visit-perday.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('House Sitting')); ?> : 
															<span> 
																<?php  if(!empty($sitterServiceData->sh_day_rate))
																	...
																	?>
															  <i data-toggle="tooltip" title="Overnight stay at your home" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
														  <li>
															<img src="<?php echo HTTP_ROOT; ?>img/meet-greet_2.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Meet')); ?> &amp; <?php echo $this->requestAction('app/get-translate/'.base64_encode('Greet')); ?>: 
															<span> 
																<?php  if(!empty($sitterServiceData->sh_day_rate))
																		{	
																				echo "$cuntry_sign_code ".$sitterServiceData->sh_day_rate;						
																	...
																	?>
															  <i data-toggle="tooltip" title="Get to know each other before booking" class="fa fa-exclamation-circle">
															  </i>
															</span>
														  </li>
                              ...
                              <span> 
                               ...
                               <li>
                              <img src="<?php echo HTTP_ROOT; ?>img/visit-perday.png" width="18" height="17" alt=""> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Walk')); ?> : 
                              <span> 
                                <?php  if($sitterServiceData->mp_recreation_status == 1)
                                  ...
                                  ?>
                                <i data-toggle="tooltip" title="Out of home playtime &amp; Walks" class="fa fa-exclamation-circle">
                                </i>
                              </span>
                              </li>
                ...
                <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <h3 class="mid-sec-title pt30  ">
                              <?php echo @$userData->first_name."'s"; ?> <?php echo $this->requestAction('app/get-translate/'.base64_encode('Neighborhood')); ?> 
                            </h3>
                            <div class="detail-cal-widget">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <h3 class="mid-sec-title pt30 "> <?php echo $this->requestAction('app/get-translate/'.base64_encode('More similar sitters near you')); ?> &nbsp; 
                      </h3>
...
?>
                                  <li>
                                    <a href="<?php echo HTTP_ROOT."search/sitter-details/".base64_encode(convert_uuencode(@$nearbyUser->id)); ?>" title="">
                                      <img alt="" src="<?php if(!empty($nearbyUser->image)){ echo HTTP_ROOT."img/uploads/".$nearbyUser->image;}else{ echo HTTP_ROOT."img/uploads/dm.png";}?>" class=" img-responsive img-circle img-thumbnail">
                                      <p class="name">
                                        <?php if(!empty($nearbyUser->first_name)){ echo $nearbyUser->first_name." ".$nearbyUser->last_name; }?>
                                      </p>
                                      <p class="loc">
                                        <?php if(!empty($nearbyUser->city)){ echo $nearbyUser->city; }else{ echo "</br>"; }?>
                                      </p>
...
<style>
.pre_day_disable{background-color:#ffffff !important;}
.not_display { display: none;}
.display_green { background-color: #7BAB0D !important;}
</style>
...
<div  id="myModal79" >
	...
	<div class="popup">		
      ...
      <div class="sqv-box">
        <div class="top-close">
          <p>
			  <?php echo $this->requestAction('app/get-translate/'.base64_encode('Contact '.ucfirst(@$userData->first_name).' for a free meet & greet')); ?>
        ...
        <div class="sr-area"> 
          ...
          <div  class="cont-sitter"> 
              ...
              <li><i class="fa fa-angle-right right-gr"></i><?php echo $this->requestAction('app/get-translate/'.base64_encode('20% discount for multiple nights (made in some booking)')); ?> </li>
                      ...
                      <!--add dog-->
                      <div class="ad-dog"> 
                      		<h2><?php echo $this->requestAction('app/get-translate/'.base64_encode('Pets')); ?></h2>   
                            <div class="row">
                            	...
                            	<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                                	<div class="ad">
                                    	<a title="Add Dogs" href="<?php echo HTTP_ROOT.'dashboard/about-guest'; ?>"><i aria-hidden="true" class="fa fa-plus-circle"></i><?php echo $this->requestAction('app/get-translate/'.base64_encode('Add Another Pet')); ?> </a>
                                    </div>
                                </div>                                                                
                            </div>
                       </div>    
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="include"> <a href="javascript:void(0)" data-toggle="collapse" data-target="#bott"><span class="include-addit"></span> &nbsp; <?php echo $this->requestAction('app/get-translate/'.base64_encode('Include additional services from Market place?')); ?></a></div>
                      ...
                      <!--message-->
                      	<div class="msg">
                            ...
                            <p class="no-bot"> <?php echo $this->requestAction('app/get-translate/'.base64_encode("Share a little info about your pet and why they'd have a great time with Agatha")); ?>. </p>
                           ...
                           <!--<textarea class="txtarea"></textarea>-->
                            ...
                            <p><?php  
                              ...
                              ?> &nbsp <?php echo $this->requestAction('app/get-translate/'.base64_encode("I'd like to receive photos of my pet during this stay")); ?>. </p>
          ...
          <div class=" col-xs-12 col-md-4 col-sm-4 col-lg-3  ">
            <div class="right-content-wrap">
              <div class="top-box-wrap">
                <div class="row">
                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> <img src="<?php echo HTTP_ROOT.'img/uploads/'.(@$userData->image != ''?@$userData->image:'dm.png'); ?>" width="50" height="50" class="img-responsive img-circle text-center center-block img-thumbnail" alt="image"> </div>
              ...
              <div class="booking-summ" id="bookingPetInfo">
                 <h3><?php echo $this->requestAction('app/get-translate/'.base64_encode('Your Booking Summary')); ?></h3>
              </div>
             <!--Start pet info-->
