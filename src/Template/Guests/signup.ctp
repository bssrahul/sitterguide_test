                ...
                <div class="col-lg-offset-2 col-sm-offset-2 col-md-offset-2 col-xs-offset-0 col-lg-8 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <div class="form-part">
                         ...
                         <?php 
                                echo $this->Form->input('Users.country',[
                                  ...
                                  'type'=>'select',
                                  'label'=>false,
                                  'options'=>[''=>'Choose Country','Australia'=>'Australia','New Zealand'=>'New Zealand','UK'=>'UK','USA'=>'United State America'],
                                  'class' =>'form-control'
                                  ]);
                    ...
                    <?php echo $this->Form->end(); ?>
                     ...
                     <div id="loginFacebook">
                        ...
                        <p><?php echo $this->requestAction('app/get-translate/'.base64_encode('Already a member?')); ?> <span class="signup-color"><a href="<?php echo HTTP_ROOT.'guests/login'; ?>"><?php echo $this->requestAction('app/get-translate/'.base64_encode('Sign In')); ?></a></span></p>
                      </div>
