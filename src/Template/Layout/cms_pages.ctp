...
<html lang="<?php echo $languageSession->read('requestedLanguage'); ?>" xml:lang="<?php echo $languageSession->read('requestedLanguage'); ?>">
   <head>
		...
		<?php 
			...
			echo $this->Html->script(['Front/jquery.min.js','Front/jquery.validate.js','Front/owl.carousel.min.js','Front/dist/jquery.imgareaselect.js','Front/dist/jquery.form.js','Front/jquery-ui.js','Front/search-filter.js','Front/custom.js']);
