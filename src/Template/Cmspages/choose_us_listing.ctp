...
<div class="">
	...
	<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2><?php echo $this->requestAction('app/get-translate/'.base64_encode(' Why Choose us ')); ?></h2><!--<h2 style="float:right"> <a style="float:right" href="<?php echo HTTP_ROOT.'cmspages/add-choose-us'; ?>"><button class="btn btn-success addUser" type="button">Add Choose Us</button></a></h2>-->
						 ...
						 ?>
							...
							echo strtoupper(str_replace("_"," ",$work_info->category));
								...
								<td class=" last">
								  ...
								  <a title="<?php echo $this->requestAction('app/get-translate/'.base64_encode('Edit')); ?>" href="<?php echo HTTP_ROOT."cmspages/edit-choose-us/".$work_info->id;?>"><span><i class="fa fa-pencil-square"></i></span></a>
