<div class="">
                   <div class="row">
					 <div class="col-md-12 col-sm-12 col-xs-12">
						    <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $this->requestAction('app/get-translate/'.base64_encode('Add News Updates')); ?><?php echo $this->requestAction('app/get-translate/'.base64_encode('Add News Updates')); ?><small></small></h2>
