				...
				if(isset($this->request->data['g-recaptcha-response']) && !empty($this->request->data['g-recaptcha-response']))
				  {
					...
					if($responseData->success)
					{
                     ...
                     $userData = $usersModel->newEntity();
		                ...
		                */
		                $userData->id = $userId;
		                /* get latitute and longitude -- Sachin kumar */
							...
							// echo $sourceLocationLatitude;
							// echo $sourceLocationLongitude;die;
...
function addPets(){
	...
	*/
          ...
          if($_FILES['image']['name']!=''){
				    ...
				    $res = $this->saveAvatar(array(
			          ...
			          $src = HTTP_ROOT.'webroot/img/uploads/'.$profilePic[1];
				        echo "<img  id='photo' class='' src='".$src."' class='preview' height='400px'; width='400px'>";
				}				
	...
	if(isset($_POST['t']) and $_POST['t'] == "ajax")
	{
	 ...
	 echo HTTP_ROOT."img/uploads/".$img;
		//exit(0);    
		die;
	}
