...
define("SET_DEFAULT_PAGINATE",10);
ini_set('intl.default_locale', 'en_US');

/*DEFAULT LATITUDE AND LONGITUDE ACCORDING TO IP START*/
	...
	if ($data) {
		...
		if($lat =='' && $lon==''){
			...
			define("DEFAULT_LAT",'30.7399738');
			define("DEFAULT_LONG",'76.7567368');
		}else{
			
			define("DEFAULT_LAT",$lat);
			define("DEFAULT_LONG",$lon);
		}
...
/*DEFAULT LATITUDE AND LONGITUDE ACCORDING TO IP END*/
